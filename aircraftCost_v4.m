...
Q = 60; %lesser of production quantity OR number to be produced in 5 years (Q is either 30, 60, 90)
...
avg_FH = 1400; %average yearly flight hours per aircraft (700~1400 for military transport) 
